...
JHtml::stylesheet('templates/' . JFactory::getApplication()->getTemplate().'/html/mod_sj_content_accordion/sj-accordion.css');
		...
		<div class="acd-items">
			...
			<div class="acd-item">
				<div class="acd-header">
					<?php echo str_replace("...","",SjContentAccordionHelper::truncate($item->title, $params->get('item_title_max_characters',25))); ?>
				</div>
