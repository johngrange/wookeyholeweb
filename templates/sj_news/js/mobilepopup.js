...
var MobilePop = new Class({
	...
	initialize: function(el, options) {
		...
		this.overlay.setStyles({'position': 'absolute', 'background': 'none repeat scroll 0 0 #000000', 
							   'visibility': 'visible', 'left': 0, 'top': 0, 'z-index': 777, 'width': window.getWidth(), 'height': window.getHeight() + window.getScrollHeight()});
...
MobilePop.implement(new Options);
MobilePop.implement(new Events);