...
<style>
   ...
   .ark.navbar .nav > li > a {
	...
	@font-face {
	  font-family: 'arklogo';
	  src: url('layouts/joomla/arkeditor/images/fonts/arklogo.eot?45275132');
	  src: url('layouts/joomla/arkeditor/images/fonts/arklogo.eot?45275132#iefix') format('embedded-opentype'),
		   url('layouts/joomla/arkeditor/images/fonts/arklogo.woff?45275132') format('woff'),
		   url('layouts/joomla/arkeditor/images/fonts/arklogo.ttf?45275132') format('truetype'),
		   url('layouts/joomla/arkeditor/images/fonts/arklogo.svg?45275132#arklogo') format('svg');
	  font-weight: normal;
	  font-style: normal;
	}
	...
	.ark.navbar {position: fixed;width:340px;top:45%;right:-275px;z-index:1001;}
