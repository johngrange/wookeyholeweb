 ...
 * @subpackage   Integrations\Activities
 */
class ITPrismIntegrateActivitySocialCommunity implements ITPrismIntegrateInterfaceActivity
{
    protected $id;
    protected $content;
    protected $image;
     ...
     * $content = "...";
     *
     * $activity = new ITPrismIntegrateActivitySocialCommunity($userId, $content);
     * </code>
     *
     ...
     * );
     *
     * $activity = new ITPrismIntegrateActivitySocialCommunity();
     * $activity->bind($data);
     * </code>
     *
     * @param array $data
    ...
    public function store($content = "")
    {
        ...
        $activity->setUserId($this->user_id);

        if (!empty($this->image)) {
            $activity->setImage($this->image);
        }
