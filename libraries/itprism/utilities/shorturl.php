...
class ITPrismShortUrl
{
     ...
     * );
     *
     * $urlService = new ITPrismShortUrl($url, $options);
     * </code>
     *
     * @param string $url
     * @param array $options
     ...
     * );
     *
     * $urlService = new ITPrismShortUrl($url);
    ...
    public function getUrl()
    {
        ...
        if (!in_array('curl', $installedLibraries)) {
            throw new Exception("LIB_ITPRISM_ERROR_SHORT_URL_SERVICE_REQUEST");
        }
    ...
    protected function getBitlyURL($domain = "bit.ly")
    {
        ...
        if (!empty($response)) {
            ...
            throw new Exception(JText::_("LIB_ITPRISM_ERROR_SHORT_URL_SERVICE_REQUEST"));
        }
    }
    ...
    protected function getGoogleURL()
    {
        ...
        if (!empty($response)) {
            ...
            throw new Exception(JText::_("LIB_ITPRISM_ERROR_REDUCE_URL"));
        }
    }
}
