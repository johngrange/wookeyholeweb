...
abstract class EHtml extends JHtml
{
	...
	public static function imageControl($selected, $name, $label, $desc, $idTag = null, $class = null, $preview = false)
	{
		...
		*/
		...
		if ($manage)
		{
			$control[] = '<a class="btn modal" rel="{handler: \'iframe\', size: {x: 800, y: 500}}" href="index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=com_autotweet&amp;author=' .
				JFactory::getUser()->id . '&amp;fieldid=' .
