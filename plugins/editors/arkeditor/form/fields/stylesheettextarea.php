...
class JFormFieldStylesheetTextarea extends JFormFieldTextarea 
{
	...
	protected function getInput()
	{
		...
		$button	= 
		'<br clear="left"/><br /><input type="button" class="btn" id="modal'.$identifier.'" href="../plugins/editors/arkeditor/form/fields/modals/typography.php" rel="{handler: \'iframe\' , size: {x:640, y:480}}" value="Expand View"/>
