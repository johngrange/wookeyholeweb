...
class ARKHelper
{
	...
	public static function getExternalLinks( $message = false, $type = 'error', $location = 'messagequeue' )
	{
		...
		$links['ark-pro'] 			= 'http://arkextensions.com/plans';
		$links['ark-guide'] 		= 'http://arkextensions.com/extensions/ark-editor/user-guide';
	...
	{
		$hide = array( 'about', 'save', 'mediamanager','imagemanager','treelink' );
