...
defined('CAUTOTWEETNG_VERSION') || define('CAUTOTWEETNG_VERSION', '7.9.6');
...
JLoader::register('BloggerChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/blogger.php');
...
JLoader::register('EasySocialChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/easysocial.php');
...
JLoader::register('ImageUtil', JPATH_AUTOTWEET_HELPERS . '/image.php');
JLoader::register('JomSocialChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/jomsocial.php');
...
JLoader::register('LiOAuth2ChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/lioauth2.php');
JLoader::register('LiOAuth2CompanyChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/lioauth2company.php');
...
JLoader::register('RouteHelp', JPATH_AUTOTWEET_HELPERS . '/route-help.php');
JLoader::register('RuleEngineHelper', JPATH_AUTOTWEET_HELPERS . '/ruleengine.php');
JLoader::register('ScoopitChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/scoopit.php');
...
JLoader::register('TumblrChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/tumblr.php');
...
JLoader::register('XingChannelHelper', JPATH_AUTOTWEET_HELPERS . '/channels/xing.php');
...
/**
 *
 * HOW TO: http://www.extly.com/docs/autotweetng_joocial/own-plugin.html#how-to-use-autotweetng-api---case-study-e-shop
 *
