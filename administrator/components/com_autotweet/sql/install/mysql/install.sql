CREATE TABLE IF NOT EXISTS `#__autotweet_requests` (
  ...
  PRIMARY KEY  (`id`),
  INDEX `req_publish_up` (`publish_up`)
...
INSERT INTO `#__autotweet_channeltypes`
	(`id`, `name`, `description`, `max_chars`) 
	VALUES (5, 'LinkedIn User (Legacy)', 'COM_AUTOTWEET_CHANNEL_LINKEDIN_DESC', 200);

INSERT INTO `#__autotweet_channeltypes`
	(`id`, `name`, `description`, `max_chars`) 
	VALUES (6, 'LinkedIn Group for Partners', 'COM_AUTOTWEET_CHANNEL_LINKEDINGROUP_DESC', 200);	
...
INSERT INTO `#__autotweet_channeltypes`
	(`id`, `name`, `description`, `max_chars`) 
	VALUES (10, 'LinkedIn Company (Legacy)', 'COM_AUTOTWEET_CHANNEL_LINKEDINCOMPANY_DESC', 200);
...
INSERT INTO `#__autotweet_channeltypes`
	(`id`, `name`, `description`, `max_chars`) 
	VALUES (13, 'Google+ Moments (Legacy)', 'COM_AUTOTWEET_CHANNEL_GPMOMENTS_DESC', 320);
...
INSERT INTO `#__autotweet_channeltypes`
	(`id`, `name`, `description`, `max_chars`) 
	VALUES (20, 'LinkedIn User', 'COM_AUTOTWEET_CHANNEL_LINKEDIN2015_DESC', 200);

INSERT INTO `#__autotweet_channeltypes`
	(`id`, `name`, `description`, `max_chars`) 
	VALUES (21, 'LinkedIn Company', 'COM_AUTOTWEET_CHANNEL_LINKEDINCOMPANY5015_DESC', 200);
...
INSERT INTO `#__autotweet_ruletypes`
	(`id`, `name`, `description`) VALUES (24, 'featured: IS', 'COM_AUTOTWEET_RULE_FEATURED_DESC');
INSERT INTO `#__autotweet_ruletypes`
	(`id`, `name`, `description`) VALUES (25, 'featured: IS NOT', 'COM_AUTOTWEET_RULE_FEATUREDISNOT_DESC');
INSERT INTO `#__autotweet_ruletypes`
	(`id`, `name`, `description`) VALUES (26, 'media: HAS', 'COM_AUTOTWEET_RULE_MEDIAHAS_DESC');
INSERT INTO `#__autotweet_ruletypes`
	(`id`, `name`, `description`) VALUES (27, 'media: HAS NOT', 'COM_AUTOTWEET_RULE_MEDIAHASHOT_DESC');
