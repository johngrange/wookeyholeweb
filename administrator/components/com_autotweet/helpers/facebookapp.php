 ...
 * @subpackage  ServerAuth - A powerful social content platform to manage multiple social networks.
 *
...
class FacebookApp
{
	...
	public $permissions = 'public_profile,publish_actions,publish_pages,manage_pages,user_managed_groups,user_photos';
