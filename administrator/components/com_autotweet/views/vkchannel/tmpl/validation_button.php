...
$channeltypeId = $this->input->get('channeltype_id', AutotweetModelChanneltypes::TYPE_VK_CHANNEL, 'cmd');
$requireGroup = ($channeltypeId == AutotweetModelChanneltypes::TYPE_VKGROUP_CHANNEL);
