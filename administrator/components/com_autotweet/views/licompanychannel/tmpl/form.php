...
<div class="control-group">
	<label class="required control-label" for="xtformlicompany_id" id="licompany_id-lbl"><?php echo JText::_('COM_AUTOTWEET_CHANNEL_LINKEDIN_COMPANY_ID'); ?> <span class="star">&nbsp;*</span></label>
	<div class="controls">
		<a class="btn btn-info" id="licompanyloadbutton"><?php echo JText::_('COM_AUTOTWEET_VIEW_CHANNEL_LOADBUTTON_TITLE'); ?></a>
		<?php echo SelectControlHelper::licompanies(
...
<?php
		...
		$social_target = 'social_url_licompany';
		require dirname(__FILE__) . '/../../channel/tmpl/social_url.php';
