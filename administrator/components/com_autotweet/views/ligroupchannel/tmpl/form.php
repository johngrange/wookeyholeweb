...
<?php echo JText::_('COM_AUTOTWEET_CHANNEL_LINKEDIN2015_DESC'); ?>
...
<div class="control-group">
	<label class="required control-label" for="xtformligroup_id" id="ligroup_id-lbl"><?php echo JText::_('COM_AUTOTWEET_CHANNEL_LINKEDIN_GROUP_ID'); ?> <span class="star">&nbsp;*</span></label>
	<div class="controls">
		<a class="btn btn-info" id="ligrouploadbutton"><?php echo JText::_('COM_AUTOTWEET_VIEW_CHANNEL_LOADBUTTON_TITLE'); ?></a>
		<?php echo SelectControlHelper::ligroups(
				$this->item->xtform->get('group_id'),
				'xtform[group_id]',
				array(),
				$this->item->xtform->get('api_key'),
				$this->item->xtform->get('secret_key'),
				$this->item->xtform->get('oauth_user_token'),
				$this->item->xtform->get('oauth_user_secret')
			);
		?>
	</div>
</div>
...
<?php
		...
		$social_target = 'social_url_ligroup';
		require dirname(__FILE__) . '/../../channel/tmpl/social_url.php';
