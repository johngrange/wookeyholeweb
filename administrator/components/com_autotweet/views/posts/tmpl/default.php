...
?>
				...
				?>
				<a target="_blank" href="http://www.extly.com/docs/autotweetng_joocial/troubleshooting.html#there-are-requests-in-the-list-waiting-to-be-published-but-they-are-not-delivered-why"><i class="xticon xticon-link"></i></a>
				</div></div>
			</div>
							<?php
							}
