...
?>
	...
	?>
							...
							<a ng-click="request.previewImage = !request.previewImage" title="<?php echo JText::_('COM_AUTOTWEET_COMPOSER_VIEW_IMAGE'); ?>"
								target="_blank" ng-if="request.image_url != null"><i class="xticon xticon-image"></i></a>
	...
	?>
								...
								<a ng-if="request.published == 1" class="btn btn-inverse btn-mini"
									ng-click="requestsCtrl.requestsTable.backtoQueueRow(request)"><i class="xticon xticon-retweet"></i></a>
	<?php
							}
	?>
							</div>
						...
						<p ng-if="request.previewImage">
							<img ng-src="{{request.image_url}}" alt="{{request.description}}" class="img-polaroid span12">
						</p>
					</td>
...
?>
		...
		<p class="text-right"><a data-original-title="<?php echo JText::_('JGLOBAL_HELPREFRESH_BUTTON'); ?>" rel="tooltip"
			ng-click="requestsCtrl.requestsTable.doRefresh()">
			<i class="xticon xticon-refresh"></i>
		</a></p>
